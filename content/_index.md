...
{{% timespan from="2004-09" to="2010-08" %}}
{{% assignments id="assignments-others" file="data/assignments/others.json" %}}
{{% /article %}}

{{% /section %}}

{{% section class="extracurricular-experience" %}}
...
{{% timespan from="2020-06" to="now" %}}
{{% assignments id="assignments-coders-only" file="data/assignments/coders-only.json" %}}
...
{{% assignments id="assignments-unibe" file="data/assignments/unibe.json" %}}
